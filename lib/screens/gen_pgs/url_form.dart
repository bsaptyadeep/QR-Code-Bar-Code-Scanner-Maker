              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    const Text('Enter a Website Url',
                        style: TextStyle(
                            color: blue2,
                            fontSize: 30,
                    ...
                    MaterialButton(
                      ...
                      onPressed: () async{
                        if (_formKey.currentState!.validate()) {
                          ...
                          History newHis = History(id: _hisId, oper: 'Generate', txt: controllerurl.text, date: '${DateTime.now().year}-${DateTime.now().month}-${DateTime.now().day}');
                          _hisId = await _dbHelper.insertHis(newHis);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Generate(val: 'http://${controllerurl.text}')),
                          ).then(
                            (value) {
                              setState(() {});
                            },
